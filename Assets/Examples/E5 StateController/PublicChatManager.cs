...
namespace Examples.E5_StateController
{
    ...
    public class PublicChatSystemOld<TChatter> where TChatter : class, IChatter
    {
    ...
    #region Entry
        ...
        public PublicChatSystemOld(SetSingleChatter SetMute, Action<string> Log, UpdateStateCallback StateChangeNotification, string[] character_order_table)
        {
